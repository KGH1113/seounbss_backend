...
app.post('/suggestion-request', (req, res) => {
  ...
  if (suggestion_blacklist.some(item => item.name === name || item.studentNumber === studentNumber)) {
